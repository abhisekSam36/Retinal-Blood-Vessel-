...
# NOTE: The get_gnet function is also outdated and will not run without significant changes.
# It is left here for reference but is not used by default.
def get_gnet(n_ch,patch_height,patch_width):
    ...
    #
    conv3 = Conv2D(32, (3, 3), activation='relu', padding='same')(pool1)
    conv3 = Dropout(0.2)(conv3)
    conv3 = Conv2D(32, (3, 3), activation='relu', padding='same')(conv3)
    pool2 = MaxPooling2D(pool_size=(2, 2))(conv3)
    #
    conv4 = Conv2D(64, (3, 3), activation='relu', padding='same')(pool2)
    conv4 = Dropout(0.2)(conv4)
    ...
    conv8 = Conv2D(16, (3, 3), activation='relu', padding='same')(up4)
    conv8 = Dropout(0.2)(conv8)
    conv8 = Conv2D(16, (3, 3), activation='relu', padding='same')(conv8)
    #
    pool4 = MaxPooling2D(pool_size=(2, 2))(conv8)
    conv9 = Conv2D(32, (3, 3), activation='relu', padding='same')(pool4)
